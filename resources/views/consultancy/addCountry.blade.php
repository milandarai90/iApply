...
<div class="container mb-5">
    ...
    <div class="me-2 ms-2 d-flex justify-content-center" >
        <form action="{{route('consultancy.postCountry')}}" method="POST" class="p-4 border border-2 w-50" style="border-radius: 3%" enctype="multipart/form-data">
    @csrf
...
<script>
 ...
 document.getElementById('country').classList.add("menu-open");
 document.getElementById('addCountry').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
</script>
@endsection