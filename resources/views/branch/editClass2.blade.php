...
<div class="container mb-5">
    <div class="d-flex justify-content-center mt-3 ">
        <h5 class="text-danger">update Classes</h5>
    </div>
        <div class="mt-2 mb-2" >
    ...
    <div class="me-2 ms-2 d-flex justify-content-center" >
        <form action="{{route('branch.updateClass2')}}?uid={{$uid}}&cid={{$cid}}&courseid={{$courseid}}" method="POST" class="p-2 border border-2 w-75" style="border-radius: 3%" enctype="multipart/form-data">
            @csrf
            <div class="d-flex mt-2">
                <div class="col-4"><label for="class_name">Class Name :</label></div>
                <div class="col-8">
                    <input type="text" class="form-control form-control-sm" value="{{$class->class_name}}" name="class_name" required>
                    <div class="mt-1">
                        @error('class_name')
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <select class="form-select form-select-sm" aria-label="select consultancy" name="course">
                        <option value="{{$class->course_id}}" selected>{{$class->course->course}}</option>
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <input type="number" value="{{$class->seats_number}}" class="form-control form-control-sm" name="seats_number" required>
                    <div class="mt-1"> 
                        @error('seats_number')
                        <span class="text-danger">
                            {{$message}}
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <input type="time" value="{{$class->starting_time}}" class="form-control form-control-sm" name="starting_time" required>
                    <div class="mt-1">
                        @error('starting_time')
                        <span class="text-danger">
                            {{$message}}
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <input type="time" value="{{$class->ending_time}}" class="form-control form-control-sm" name="ending_time" required>
                    <div class="mt-1">
                        @error('ending_time')
                        <span class="text-danger">
                            {{$message}}
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <input type="date"  value="{{$class->starting_date}}" class="form-control form-control-sm" name="starting_date" required>
                    <div class="mt-1">
                        @error('starting_date')
                        <span class="text-danger">
                            {{$message}}
            ...
            <div class="d-flex mt-2">
                ...
                <div class="col-8">
                    <input type="date" class="form-control form-control-sm"  value="{{$class->ending_date}}" name="ending_date" required>
                    <div class="mt-1">
                        @error('ending_date')
                        <span class="text-danger">
                            {{$message}}
