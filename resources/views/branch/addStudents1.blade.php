...
<div class="container mb-5">
    ...
    <div class="me-2 ms-2 d-flex justify-content-center" >
        <form action="{{route('branch.postStudents1')}}?uid={{$uid}}&cid={{$cid}}&courseid={{$courseid}}" method="POST" class="p-2 border border-2 w-75" style="border-radius: 3%" enctype="multipart/form-data">
            @csrf
