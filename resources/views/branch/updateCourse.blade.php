...
<div class="container mb-5">
    ...
    <div class="me-2 ms-2 d-flex justify-content-center" >
        <form action="{{route('branch.submitCourse')}}?uid={{$uid}}&id={{$id}}" method="POST" class="p-2 border border-2 w-75" style="border-radius: 3%" enctype="multipart/form-data">
            @csrf
            
            <div class="d-flex mt-2">
                <div class="col-4"><label for="course">Change course Name</label></div>
                <div class="col-8">
                    <input type="text" class="form-control form-control-sm" name="course" value="{{$data->course}}" required>
                    <div class="mt-1">
                        @error('course')
