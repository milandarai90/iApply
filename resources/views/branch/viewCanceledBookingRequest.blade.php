        ...
        <div id="table">
            <table class="text-center table table-bordered table-hover mt-2">
                ...
                <tr>
                    ...
                    {{-- <a href=""> <span class="text-primary">Accept</span></a> --}}
                    </td>
                </tr>
                    @endforeach
            </table>
...
@else
    <div class="container">
        <div class="mt-3 d-flex justify-content-center">
            <h5 class="text-danger">No canceled requests.</h5>
        </div>
    </div>
       ...
       <script>
        ...
        setTimeout(function () {
            ...
            document.getElementById('requests').classList.add("menu-open");
               document.getElementById('canceledBookingRequests').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
 </script>
