...
@else
    <div class="container">
        <div class="mt-3 d-flex justify-content-center">
            <h5 class="text-danger">No rejected requests.</h5>
        </div>
    </div>
       ...
       <script>
        ...
        setTimeout(function () {
            ...
            document.getElementById('requests').classList.add("menu-open");
               document.getElementById('rejectedBookingRequests').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
 </script>
