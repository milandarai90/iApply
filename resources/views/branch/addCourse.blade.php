...
<div class="container mb-5">
    ...
    <div class="me-2 ms-2 d-flex justify-content-center" >
        <form action="{{route('branch.postCourse')}}" method="POST" class="p-2 border border-2 w-75" style="border-radius: 3%" enctype="multipart/form-data">
            @csrf
            
            <div class="d-flex mt-2">
                <div class="col-4"><label for="course">Course Name</label></div>
                <div class="col-8">
                    <input type="text" class="form-control form-control-sm" name="course" placeholder="eg. IELTS" required>
                    <div class="mt-1">
                        @error('course')
    ...
    <script>
        ...
        setTimeout(function () {
           ...
           document.getElementById('addCourse').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
    </script>
@endsection