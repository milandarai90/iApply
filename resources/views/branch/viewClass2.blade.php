        ...
        <div id="viewClass" class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 mt-2 ms-3">
            ...
            <div class="d-flex">
               <div class="col d-flex justify-content-center  fw-bold" >
                <a href="{{route('branch.deleteClass')}}?uid={{$item->classBranch->userBranch->personalAccessTokens->first()->token}}&cid={{$item->id}}&courseid={{$courseid}}" class="text-decoration-none text-light"><i class="bi bi-trash3"></i></a>
               </div>
               <div class="col d-flex justify-content-center  fw-bold">
