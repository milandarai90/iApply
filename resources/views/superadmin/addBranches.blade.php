...
<div class="container mb-5">
            ...
            <div class="d-flex">
                ...
                <div class="col-8">
                    <select class="form-select form-select-sm" aria-label="select consultancy" name="consultancyName">
                        ...
                        <option value="{{$item->id}}" class="text-danger">{{$item->consultancyDetails->name}}
                        </option>
                        @endforeach
                      </select>
                    <div class="mt-1">
    ...
    <script>
        ...
        setTimeout(function () {
           ...
           document.getElementById('addBranch').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
    </script>
@endsection